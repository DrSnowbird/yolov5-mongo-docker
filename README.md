...
* All the results/outputs generated by 'run.sh' (calling Yolov5 detect.py) will be saved and available in [ FTP Jetty File Server, MongoDb, MongoExpress]
* All the generated / annotated images will be available in FTP Jetty File Server as Web URL links
* All the generated inferences in JSON will be stored in MongoDb - accessible using MongoExpress or using MongoDB client from you Application to access them.
